...
public class SysTenantParamUtil {
	 ...
	 * @date 2015-12-16 上午11:46:42
	 */
	public static String getParaValueByParamCode(String param_code ,String tid) {
		// 查询 租户参数信息
		SysTenantparam param = new SysTenantparam();
		param.setParamCode(param_code);
		param.setTid(tid);
		SysTenantparam tenantparam = sysTenantparamService.findByTidAndId(param);
		
		return tenantparam != null ? tenantparam.getDefValue() : null;
	}
}
