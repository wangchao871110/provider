...
import com.xfs.pay.alipay.config.AlipayConfig;
...
public class AlipayNotify {
	...
	private static boolean getSignVeryfy(Map<String, String> Params, String sign) {
        ...
        //获取待签名字符串
        String preSignStr = AliPayUtils.buildRequestSign(sParaNew);
        //获得签名验证结果
        ...
        if(Params.get("sign_type").equals("RSA")){
            isSign = RSA.verify(preSignStr, sign, AlipayConfig.res_public, AlipayConfig.input_charset);
        }
        return isSign;
    }
    ...
    */
    private static String checkUrl(String urlvalue) {
        ...
        try {
            ...
            log.error("aliPay支付 获取远程服务器ATN结果",e);
            inputLine = "";
        }
